    ...
    <div>
      ...
      <div>
        <ul>
          ...
          <li><a href="#example2">Example 2 - People</a></li>
      ...
      <div class="large-padded-row">
        ...
        <div class="padded-row">
          <div angucomplete-alt id="ex2" placeholder="Search people" pause="300" selected-object="selectedPerson" local-data="people" search-fields="firstName,surname" title-field="firstName,surname" description-field="twitter" image-field="pic" minlength="1" input-class="form-control form-control-small" match-class="highlight">
          </div>
        </div>
        <div class="result">
      ...
      <div class="large-padded-row">
        ...
        <h3><a name="example8" class="page-anchor">Example 8 - Required</a></h3>
        <div class="padded-row">
          <form>
            <div angucomplete-alt id="ex8" placeholder="Search countries" pause="100" selected-object="countrySelected8" local-data="countries" search-fields="name" title-field="name" minlength="1" input-class="form-control form-control-small" match-class="highlight" field-required="true">
            </div>
          </form>
        </div>
      ...
      <div class="large-padded-row">
        ...
        <div class="padded-row">
          <form>
            <div angucomplete-alt id="ex9" placeholder="Search countries" pause="100" selected-object="countrySelectedFn9" local-data="countries" search-fields="name" title-field="name" minlength="1" input-class="form-control form-control-small" match-class="highlight" field-required="true" initial-value="countrySelected9">
            </div>
          </form>
        </div>
        <div class="result">
