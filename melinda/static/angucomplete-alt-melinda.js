      ...
      function processResults(responseData, str) {
        ...
        if (responseData && responseData.length > 0) {
          ...
          for (i = 0; i < responseData.length; i++) {
            ...
            image = '';
            if (scope.imageField) {
            	if (typeof scope.imageField === 'function') {
            		var fun = scope.imageField
            		image = fun(responseData[i]);
            	} else {
